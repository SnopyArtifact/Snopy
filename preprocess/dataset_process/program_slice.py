...
class SlicingTool:
    def __init__(self, vul_funcs: Set[str], datas: List[Dict[str, Union[str, List[str]]]]):
        ...
        self.func_name2call_target_reverse: DefaultDict[str, DefaultDict[int, List[str]]] = defaultdict(
    ...
    def run_slice(self):
        for func_name, key_lines in self.key_line_set.items():
            ...
            for key_line in key_lines:
                ...
                self.extract_backward_slice(func_name, key_line, backward_slice_lines, backward_loc_idxs,
                                            backward_funcs)
